...
if __name__=="__main__":
    ...
    parser.add_argument('--pbg', help='Channel Erasure Probability for Bernouli or Probability of good to bad transition in Gilbert Elliot', type=float, default=0.5)
    parser.add_argument('--pgb', help='Probability of bad to good transition in Gilbert Elliot', type=float, default=0.4)
